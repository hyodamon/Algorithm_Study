...
항상 이런 문제를 풀 때 계속 DP를 써야한다는 사실을 까먹고, 한번 시간초과 난 뒤에 다시 풀게 된다 🥲
규칙만 찾는다면 정말 간단한 문제이다.

<img width="718" alt="image" src="https://user-images.githubusercontent.com/80052217/187875563-e5af135c-73ea-47d6-9442-ad13b873fe74.png">

이런 식으로 피보나치 이어가지므로, 이전의 0과 1의 상태를 계속 더해가주면 된다.
